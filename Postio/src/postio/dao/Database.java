...
public class Database {
    // Naam van de database staat achteraaaaaaan > 
    private static String locatieMysqlServer = "jdbc:mysql://dt5.ehb.be/IP1718003";
    private static String gebruikersnaam = "IP1718003";
    private static String wachtwoord = "38176249";
